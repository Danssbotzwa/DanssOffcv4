...
return {
conversation: 'WhatsApp Bot By DanssOffcDev.'
}}
}
...
let teksnotif = `*Dansbotz Version - 0.4 🍁*
Connected To ${Reza.user.id.split(":")[0]}`
Reza.sendMessage("62882005742954@s.whatsapp.net", {text: teksnotif})
...
*🏠 Grup Bebas Share :* https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn

*🏠 Grup Bebas Share2 :* https://chat.whatsapp.com/LrMrgZ9qI4oKlDlQFuphx2

*🏠 Grup Bebas Share3 :* https://chat.whatsapp.com/LiACUnd3LhCFoEczXYDVx4` : `Hallo Kak @${num.split("@")[0]} Selamat Datang Di *${namagc}*

*🏠 Grup Bebas Share :* https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn

*🏠 Grup Bebas Share2 :* https://chat.whatsapp.com/LrMrgZ9qI4oKlDlQFuphx2

*🏠 Grup Bebas Share3 :* https://chat.whatsapp.com/LiACUnd3LhCFoEczXYDVx4`, 
contextInfo: {mentionedJid: [...tag], externalAdReply: { thumbnailUrl: ppuser, title: '© Welcome Message', body: '', renderLargerThumbnail: true, sourceUrl: "https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn", mediaType: 1}}})
} 
...
*🏠 Grup Bebas Share3 :* https://chat.whatsapp.com/LiACUnd3LhCFoEczXYDVx4` : `@${num.split("@")[0]} Telah Keluar Dari Grup Ini
...
*🏠 Grup Bebas Share3 :* https://chat.whatsapp.com/LiACUnd3LhCFoEczXYDVx4`, 
contextInfo: {mentionedJid: [...tag], externalAdReply: { thumbnailUrl: ppuser, title: '© Leaving Message', body: '', renderLargerThumbnail: true, sourceUrl: "https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn", mediaType: 1}}})
}
...
*🏠 Grup Bebas Share3 :* https://chat.whatsapp.com/LiACUnd3LhCFoEczXYDVx4`, 
contextInfo: {mentionedJid: [...tag], externalAdReply: { thumbnailUrl: ppuser, title: '© Promote Message', body: '', renderLargerThumbnail: true, sourceUrl: "https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn", mediaType: 1}}})
}
...
*🏠 Grup Bebas Share3 :* https://chat.whatsapp.com/LiACUnd3LhCFoEczXYDVx4`, 
contextInfo: {mentionedJid: [...tag], externalAdReply: { thumbnailUrl: ppuser, title: '© Demote Message', body: '', renderLargerThumbnail: true, sourceUrl: "https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn", mediaType: 1}}})
}
} 
} catch (err) {
console.log(err)
