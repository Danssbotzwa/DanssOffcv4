...
text: "*All Transaksi Open *\n\n*DANSS OFFC* Menyediakan Produk & Jasa Dibawah Ini"
}),
...
buttons: [{                  
name: "cta_url",
buttonParamsJson:  `{\"display_text\":\"Beli Produk\",\"url\":\"https://wa.me/message/UBWQEG7BM6R6E1",\"merchant_url\":\"https://www.google.com\"}`
}]
})
}, 
{
header: proto.Message.InteractiveMessage.Header.fromObject({
title: `*List Produk DANSS OFFC🍁*

* Bot Push Kontak
* Script SkyBotz V4 No Enc 100%
* Nokos WhatsApp (Request Region)
* Open Mursun 5K
* Open Munok 5K
* Jasa Suntik Sosmed
* Panel Pterodactyl
* Reseller Panel 5K sebulan
  7K Perma
* Admin Panel 10K
* PT Panel 15K
* Own Panel 20K`, 
...
{
header: proto.Message.InteractiveMessage.Header.fromObject({
title: `*Sosial Media Danss Offc*

*Saluran Danss Offc :*
https://whatsapp.com/channel/0029VaiHiabGpLHZLZSdUA0z
...
buttons: [{                  
name: "cta_url",
buttonParamsJson:  `{\"display_text\":\"Beli Produk\",\"url\":\"https://wa.me/62882005742954",\"merchant_url\":\"https://www.google.com\"}`
}]
})
}]
})
...
await Reza.sendMessage(jid, {text: `${teks}`, contextInfo: {mentionedJid: mention, externalAdReply: {thumbnailUrl: global.imgreply, title: "Danssbotz Version - 0.4", body: `Selamat ${ucapan()}`, 
...
buttons: [{
"name": "single_select",
"buttonParamsJson": `{ "title": "List Menu", "sections": [{ "title": "# Pilih List Menu Di Bawah Ini", "rows": [{ "header": "All Command", "title": "List All Command Bot", "description": "© DanssOffc", "id": ".allmenu" }, 
{ "header": "Main Menu", "title": "List Main Menu Command", "description": "© DanssOffc", "id": ".mainmenu" }, 
{ "header": "Downloader", "title": "List Downloader Command", "description": "© DanssOffc", "id": ".downloadmenu" }, 
{ "header": "Converter", "title": "List Converter Command", "description": "© DanssOffc", "id": ".convertmenu" }, 
{ "header": "Pterodactyl Panel", "title": "List Pterodactyl Panel Command", "description": "© DanssOffc", "id": ".panelmenu" }, 
{ "header": "Domain Menu", "title": "List Domain Menu Command", "description": "© DanssOffc", "id": ".domainmenu" }, 
{ "header": "Store Menu", "title": "List Store Menu Command", "description": "© DanssOffc", "id": ".storemenu" }, 
{ "header": "Group Menu", "title": "List Group Menu Command", "description": "© DanssOffc", "id": ".grupmenu" }, 
{ "header": "Owner Menu", "title": "List Ownerbot Menu Command", "description": "© DanssOffc", "id": ".ownermenu" }]}, { "title": "# Produk Owner Bot", "rows": [{ "header": "All Produk Owner", "title": "List All Produk Owner", "description": "© DanssOffc", "id": ".produkmenu" }]}, { "title": "# Tools Owner Bot", "rows": [{ "header": "Auto Read", "title": "Pilih Opsi ON/OFF", "description": "© DanssOffc", "id": ".autoread" }, 
{ "header": "Auto Read Story", "title": "Pilih Opsi ON/OFF", "description": "© DanssOffc", "id": ".autoreadsw" }, 
{ "header": "Anti Call", "title": "Pilih Opsi ON/OFF", "description": "© DanssOffc", "id": ".anticall" }]}]}`
},
{
...
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Join Saluran\",\"url\":\"https://whatsapp.com/channel/0029Vaof3M1GE56ow9i2Qs3X",\"merchant_url\":\"https://www.google.com\"}`
}]
}), 
contextInfo: {
isForwarded: true,
...
{ 
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Testimoni\",\"url\":\"https://whatsapp.com/channel/0029Vaof3M1GE56ow9i2Qs3X",\"merchant_url\":\"https://www.google.com\"}`
},
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Join Grup\",\"url\":\"https://chat.whatsapp.com/HAkvwl3XiPRLTJ0ST5Xobn",\"merchant_url\":\"https://www.google.com\"}`
}]
}), 
contextInfo: {
isForwarded: true,
...
case "list_scbot": {
let teks = `
Script *Danssbotz V4* Di Jual Dengan Harga *Rp40.000*, Jika Berminat Silahkan Klik Tombol Di Bawah Ini`
let msgii = generateWAMessageFromContent(m.chat, { viewOnceMessage: { message: { 
"messageContextInfo": { 
"deviceListMetadata": {}, 
"deviceListMetadataVersion": 2
...
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Join Saluran\",\"url\":\"${global.linksaluran}\",\"merchant_url\":\"https://www.google.com\"}`
}, 
{
"name": "cta_url",
...
for (let jid of usergc) {
try {
await Reza.sendMessage(jid, {image: await fs.readFileSync(imgtesti), caption: text, contextInfo: { isForwarded: true, mentionedJid: [m.sender], businessMessageForwardInfo: { businessOwnerJid: global.owner }, forwardedNewsletterMessageInfo: { newsletterName: `Testimoni By DanssOffc 🍁`, newsletterJid: global.idsaluran }}}, {quoted: qtext2})
total += 1
} catch {}
...
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Join Saluran\",\"url\":\"${global.linkgc}\",\"merchant_url\":\"https://www.google.com\"}`
}]
}),
})}
}}, {userJid: m.sender, quoted: qtext2})
